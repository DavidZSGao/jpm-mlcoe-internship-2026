...
- PMMH uses the standard PF (`mlcoe_q2.models.filters.particle_filter`) to estimate the
  marginal likelihood; HMC uses the DPF (`mlcoe_q2.models.filters.differentiable_pf`)
...
from mlcoe_q2.models.filters import particle_filter, differentiable_particle_filter
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--pmmh-iters", type=int, default=200)
    parser.add_argument("--pmmh-proposal-std", type=float, default=0.1)
    parser.add_argument("--hmc-samples", type=int, default=200)
    parser.add_argument("--hmc-step-size", type=float, default=0.1)
    parser.add_argument("--hmc-leapfrog", type=int, default=5)
    parser.add_argument("--output", type=Path, default=None)
    parser.add_argument(
        "--eager",
        action="store_true",
        help="Run TensorFlow functions eagerly to reduce compilation overhead",
    )
