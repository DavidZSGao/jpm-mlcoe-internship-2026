...
| --- | --- | --- | --- |
| Forecaster evaluation | ✅ Present | `reports/q1/artifacts/forecaster_evaluation.parquet` | Size: 9695 bytes |
| Forecaster evaluation summary | ✅ Present | `reports/q1/artifacts/forecaster_evaluation_summary.parquet` | Size: 8019 bytes |
| Scenario reasonableness diagnostics | ✅ Present | `reports/q1/artifacts/scenario_reasonableness.parquet` | Size: 10000 bytes |
| Macro-conditioned scenarios | ✅ Present | `reports/q1/artifacts/macro_conditioned_scenarios.parquet` | Size: 24105 bytes |
