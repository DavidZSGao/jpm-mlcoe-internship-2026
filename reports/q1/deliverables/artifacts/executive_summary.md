...
- **optimistic**; Assets MAE: 44,798,003,786.45; Assets MAPE: 0.13; Equity MAE: 160,704,983,952.38; Equity MAPE: 0.72; Net income MAE: N/A; Net income MAPE: N/A; Identity-gap MAE: 1,235,499,707.71; n=18
- **stress**; Assets MAE: 44,798,003,786.45; Assets MAPE: 0.13; Equity MAE: 160,704,983,952.38; Equity MAPE: 0.72; Net income MAE: N/A; Net income MAPE: N/A; Identity-gap MAE: 1,235,499,707.71; n=18
...
- **mild_downturn**; macro: gdp_growth=0.003, policy_rate=0.038, unemployment_rate=0.049; adjustments: 1 (pred_equity)
- **rate_shock**; macro: gdp_growth=0.01, policy_rate=0.0625, unemployment_rate=0.042; adjustments: 2 (pred_equity, pred_total_assets)

## LLM benchmarking
- flan-t5/t5-small: MAE N/A (± N/A); coverage 0.0% (± 0.0%); records=99; seeds=3
