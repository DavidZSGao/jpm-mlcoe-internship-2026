...
The figures below are generated by the reporting pipelines under `reports/figures/` and mirror the plots included in the interim report.
They illustrate filter accuracy, effective sample size, and particle‑flow behavior across Li (2017) and Hu (2021) scenarios, including
ESS and Jacobian magnitude diagnostics for EDH and LEDH.

![Nonlinear filter RMSE](../figures/nonlinear_rmse.png)
![Nonlinear filter ESS](../figures/nonlinear_ess.png)
![LGSSM validation means](../figures/lgssm_validation_means.png)

![Li 2017 PF-PF EDH ESS](../figures/li2017_pfpf_EDH_ess.png)
![Li 2017 PF-PF EDH |log-J|](../figures/li2017_pfpf_EDH_logj.png)
![Li 2017 PF-PF LEDH ESS](../figures/li2017_pfpf_LEDH_ess.png)
![Li 2017 PF-PF LEDH |log-J|](../figures/li2017_pfpf_LEDH_logj.png)

![Hu 2021 kernel flow movement (matrix kernel)](../figures/hu2021_KernelMatrix_movement.png)
![Hu 2021 kernel flow observation variance (matrix kernel)](../figures/hu2021_KernelMatrix_obsvar.png)
...
Multi-seed runs quantify the resampling options: full Sinkhorn OT yields ESS $\approx$ 181 with a −103.6 log-likelihood, low-iteration OT balances runtime and ESS, and soft-resampling remains fastest but with ESS $\approx$ 120. Neural OT accelerators achieve $\approx$ 30× speed-ups over Sinkhorn while keeping transport-plan MAE $\approx$ 0.39, enabling practical gradient-based PMCMC workflows.
