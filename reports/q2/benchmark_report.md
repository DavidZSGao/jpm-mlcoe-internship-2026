...
Seeded PF-PF runs to visualize ESS, |log-J|, and per-step log-likelihood.
...
![EDH per-step LL](../figures/li2017_pfpf_EDH_loglik.png)

### LEDH
![LEDH ESS](../figures/li2017_pfpf_LEDH_ess.png)
![LEDH |log-J|](../figures/li2017_pfpf_LEDH_logj.png)
![LEDH per-step LL](../figures/li2017_pfpf_LEDH_loglik.png)
